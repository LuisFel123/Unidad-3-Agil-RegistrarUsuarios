        ...
        <div
            ...
            <div class="w-full">
                <div class="text-center">
                    <h1 class="text-3xl font-semibold text-gray-900">Edición de tus medidas</h1>
                </div>
                <div class="mt-5">
                    <form action="ActualizarM" method="post">
                        <div class="relative mt-6">
                            <input type="number" step="any" name="pesoA" required="true" 
                        ...
                        <div class="relative mt-6">
                            <input type="number" name="cinturaA" required="true" 
                                   class="peer mt-1 w-full border-b-2 border-gray-300 px-0 py-1 placeholder:text-transparent focus:border-gray-500 focus:outline-none" 
                                   autocomplete="NA" value="<%=cintura%>" />
                            <label for="usuario1" class="pointer-events-none absolute top-0 left-0 origin-left -translate-y-1/2 transform text-sm text-gray-800 opacity-75 transition-all duration-100 ease-in-out peer-placeholder-shown:top-1/2 peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-500 peer-focus:top-0 peer-focus:pl-0 peer-focus:text-sm peer-focus:text-gray-800">Agrega tu cintura</label>
                        </div>

                        <div class="flex justify-center space-x-4 my-6">
                            <div class="my-6">
                                <button type="submit" value="" name="edicion" class="w-full rounded-md bg-black px-3 py-4 text-white focus:bg-gray-600 focus:outline-none">Aceptar</button>
                            </div>

                            <div class="my-6">
                                <button type="submit" value="otro" name="otro" action="home.jsp" class="w-full rounded-md bg-black px-3 py-4 text-white focus:bg-gray-600 focus:outline-none">Cancelar</button>
                            </div>
